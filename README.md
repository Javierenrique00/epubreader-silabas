# Epub Reader por Silabas #

Es un lector de E-pub basado en el Epub Reader React de Eyvind Gerhard Sletten(Versión React) y ePubJs(Javascript) de Futurepress.


![React Reader logo](https://s3-eu-west-1.amazonaws.com/react-reader/react-reader.svg)

## Envoltura React de epubjs con modificaciones ##

W [epub.js](https://github.com/futurepress/epub.js), using the v.03 branch. 
Envoltura de React de Eyvind Gerhard Sletten: https://github.com/gerhardsletten/react-reader

## Acerca de: ##

[epub.js](https://github.com/futurepress/epub.js) es una librería excelente de Javascript, usando la envoltura en React modificada.
