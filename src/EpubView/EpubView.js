...
class EpubView extends Component {
  ...
  initReader() {
    ...
    const { location, epubOptions, getRendition, serializeSection } = this.props
    ...
    //----Hace el hook, debe pasar el evento con contents y View
    this.book.spine.hooks.serialize.register(function(contents, view) {
      if(serializeSection!=null) serializeSection(contents,view);
    });
  }
...
EpubView.propTypes = {
  ...
  serializeSection: PropTypes.func,
}
